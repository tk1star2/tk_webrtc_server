...
func (s *Signaler) HandleTurnServerCredentials(writer http.ResponseWriter, request *http.Request) {
	fmt.Println("TK: WHAT?!2");
	logger.Infof("TK: WHAT?!2")
	writer.Header().Set("Content-Type", "application/json")
	writer.Header().Set("Access-Control-Allow-Origin", "*")
    //TKADD
    //writer.Header().Set("Access-Control-Allow-Credentials", "true")
    //writer.Header().Set("Access-Control-Allow-Headers", "Origin,Content-Type,X-Amz-Date,Authorization,X-Api-Key,X-Amz-Security-Token,locale")
    //writer.Header().Set("Access-Control-Allow-Methods", "POST, OPTIONS")

    //writer.Header().Set("Access-Control-Allow-Methods", "POST, GET, OPTIONS, PUT, DELETE")
    //writer.Header().Set("Access-Control-Allow-Headers", "Accept, Content-Type, Content-Length, Accept-Encoding, Authorization,X-CSRF-Token")
...
func (s *Signaler) HandleNewWebSocket(conn *websocket.WebSocketConn, request *http.Request) {
	fmt.Println("TK: WHAT?!3");
	logger.Infof("TK: WHAT?!3")
